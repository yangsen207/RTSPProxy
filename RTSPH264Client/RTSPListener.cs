...
namespace Solace.DotNet.Rtsp {
	...
	public class RtspListener : IDisposable {
		...
		Stream _stream;
		int _sequenceNumber;
		Dictionary<int, RtspRequest> _sentMessage = new Dictionary<int, RtspRequest> ();
		...
		/// </summary>
		/// <param name="e">The <see cref="Solace.DotNet.Rtsp.RtspChunkEventArgs"/> instance containing the event data.</param>
