...
namespace Solace.DotNet.Rtsp.Sdp {
	public class SdpFile {
		static KeyValuePair<string, string> GetKeyValue (TextReader sdpStream)
		{
		...
		static Media ReadMedia (TextReader sdpStream, ref KeyValuePair<string, string> value)
		{
		...
		readonly List<Media> medias = new List<Media> ();
